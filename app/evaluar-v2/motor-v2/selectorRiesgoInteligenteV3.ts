...
const REGLAS_ACTIVIDAD: Array<{ texto: RegExp; actividad: RegExp; puntos: number }> = [
  ...
  { texto: /\b(?:ruido|emision(?:es)?|escorrentia(?:s)?)\b/, actividad: /control_ambiental_obra_polvo_ruido_emisiones_escorrentias/, puntos: 45 },
...
const REGLAS_SEMANTICAS: Array<{ texto: RegExp; riesgo: RegExp; puntos: number }> = [
  ...
  { texto: /\b(?:ruido|proteccion auditiva|exposicion auditiva)\b/, riesgo: /ruido_ambiental|ruido_vibracion/, puntos: 65 },
  ...
  {
    texto:
      /(pasillo|ruta|transito|circulacion|acceso|peatonal).*(obstru|obstacul|bloque|ocupad)|(obstru|obstacul|bloque|ocupad).*(pasillo|ruta|transito|circulacion|acceso|peatonal)/,
    riesgo: /ruta_circulacion_obstruida|orden_aseo/,
    puntos: 65,
  },
